...
class TimeCompetScoreModelBuilder(ModelBuilder):
    MODEL_IDENTIFIER = 'time_compet_score_model'
    ...
    def __call__(self):
        ...
        model = Model(inputs=[hour_input,
                              ...
                              day_of_week_input,
                              day_of_year_input,
                              compet_score_input], outputs=[main_output], name=self.MODEL_IDENTIFIER)
...
class TimeCompetScorePreprocessor(Preprocessor):
    ...
    def array_to_dict(self, data):
        ...
        for article in data:
            ...
            compet_score.append(article[LabelsView.COMPETITIVE_SCORE.value])
        ...
        result['competitive_score'] = np.array(compet_score, dtype=float)
...
def train():
    ...
    model_builder = TimeCompetScoreModelBuilder()
    model = model_builder()
    ...
    training_input = [preprocessor.training_data['hours'],
                      ...
                      preprocessor.training_data['competitive_score']]
    ...
    validation_input = [preprocessor.validation_data['hours'],
                        ...
                        preprocessor.validation_data['competitive_score']]
