...
def train():
    ...
    arg_parse.add_argument('--a_doc2vec_dim', type=int, default=default_parameters['article_doc2vec_dimensions'],
                           choices=choices_parameters['article_doc2vec_dimensions'])

    arguments = arg_parse.parse_args()

    article_doc2vec = Doc2Vec()
    article_doc2vec.load_model('article', arguments.a_doc2vec_dim)
