...
class HeadlineConvolutionModelBuilder(ModelBuilder):
    MODEL_IDENTIFIER = 'headline_convolution_model'
    ...
    def __init__(self):
        ...
        # TODO change params
        self.default_parameters['filters_size_5'] = 5
        self.default_parameters['filters_size_3'] = 5
        self.default_parameters['filters_size_1'] = 5
    ...
    def __call__(self):
        ...
        headline_embedding = Embedding(glove.embedding_vectors.shape[0],
                                       ...
                                       trainable=False)(headline_input)

        convolution_5 = Conv1D(self.parameters['filters_size_5'], kernel_size=5)(headline_embedding)
        convolution_5_max = GlobalMaxPooling1D()(convolution_5)
        convolution_3 = Conv1D(self.parameters['filters_size_3'], kernel_size=3)(headline_embedding)
        convolution_3_max = GlobalMaxPooling1D()(convolution_3)
        convolution_1 = Conv1D(self.parameters['filters_size_1'], kernel_size=3)(headline_embedding)
        ...
        main_output = Dense(1, activation='sigmoid', name=self.parameters['main_output'])(concat)
...
class HeadlineConvolutionPreprocessor(Preprocessor):
...
def train():
    ...
    model_builder = HeadlineConvolutionModelBuilder() \
